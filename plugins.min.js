...
! function(t) {
    ...
    e.default = function(t = jQuery(document)) {
        t.find('[data-dsn-grid="move-up"] , .box-image-parallax .box-image-bg').each((function(t, e) {
            ...
            })), n.classList.contains("has-scale") && (l.scale = 1.1), s.img = gsap.to(n, { ...l,
                scrollTrigger: {
                    trigger: e,
                    start: "top " + o,
                    scrub: !0
    ...
    function o() {
        gsap.registerEffect({
            ...
            effect: (t, e) => gsap.fromTo(t, e.from, { ...e.to,
                willChange: "transform , opacity",
                scrollTrigger: {
                    trigger: t,
                    scrub: e.scrub,
    ...
    function s() {
        gsap.registerEffect({
            ...
            effect: (t, e) => gsap.fromTo(i.dsnSplitting.Words(t[0]).words, e.from, { ...e.to,
                willChange: "transform , opacity",
                transformOrigin: "top left",
                ease: e.ease,
                duration: e.duration,
    ...
    const r = {
        start: function(t) {
            const e = jQuery('<div class="dsn-ajax-loader dsn-ajax-normal bg-load background-section d-flex flex-column justify-content-between text-center">'),
